...
# Load dataset:
jd_df=pd.read_csv(r'C:\Users\DELL\OneDrive\Desktop\Job-Recommendation\jd_structured_data.csv')

# Load the extracted resume skills:
file_path=r'C:\Users\DELL\OneDrive\Desktop\Job-Recommendation\CV.pdf'
skills=[]
